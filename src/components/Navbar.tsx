...
const Navbar = () => {
    ...
    <nav className='bg-[#171A21] text-white py-3 fixed top-0 left-0 w-full z-50'>
        <div className='flex justify-around content-center'>
            ...
            <Link className='content-center hover:underline' href="/">TIENDA</Link>
            <Link className='content-center hover:underline' href="/">OFERTAS</Link>
            <Link className='content-center hover:underline' href="/">BIBLIOTECA</Link>
